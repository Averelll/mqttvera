...
function mqttsend(mqttdata)
	...
	mqtt_client:publish("Vera/Test", "sent : " .. mqttdata)
end
...
function startup(lul_device)
	...
	luup.chdev.append(lul_device, child_devices, "T2", "Shed", "urn:schemas-micasaverde-com:device:TemperatureSensor:1", "D_TemperatureSensor1.xml", "", "urn:upnp-org:serviceId:TemperatureSensor1,CurrentTemperature=0", true)
...
function watchVariable(lul_device, lul_service, lul_variable, lul_value_old, lul_value_new)
	luup.log(MQTTHANDLER_LOG_NAME .. "Device: " .. lul_device .. " Variable: " .. lul_variable .. " Value " .. lul_value_old .. " => " .. lul_value_new, 1)
		local json_string = "{\"device_id\": " ..lul_device .. ", \"variable\": \"" .. lul_variable .. "\", \"newvalue\": " .. lul_value_new .. "}"
